			...
			switch(copytext(line, 1, 4))
				...
				if("(*)")
					if(!added_author && author)
						...
						if(emoji_labels)
							...
							html += "</span>"
						if(pr_num)
							html += "<a target='_blank' href='https://github.com/frosty-dev/rugoon/pull/[pr_num]' class='pr_link'><span class='pr_number'>#[pr_num]</span>&gt;</a>"
						html += "</li>"
						added_author = 1
				...
				if("(+)")
					if(!added_collapsible_author && author)
						...
						if(pr_num)
							collapsible_html += "<a target='_blank' href='https://github.com/frosty-dev/rugoon/pull/[pr_num]' class='pr_link'><span class='pr_number'>#[pr_num]</span>&gt;</a>"
						collapsible_html += "</li>"
